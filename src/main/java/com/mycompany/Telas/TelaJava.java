...
public class TelaJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Java: Do Básico ao Avançado");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(17, 27, 345, 29);
        ...
        jTextPane1.setText("Este curso completo de Java é ideal para quem deseja iniciar sua jornada na programação ou aprimorar seus conhecimentos nessa linguagem poderosa. Você aprenderá desde os conceitos básicos até tópicos avançados, como orientação a objetos, frameworks e desenvolvimento de aplicações web.\n\nEste curso é indicado para:\nIniciantes em programação\n\nO que você vai aprender?\n- Sintaxe básica da linguagem\n- Orientação a objetos\n- Coleções e estruturas de dados\n- Exceções e tratamento de erros\n- Interfaces e herança\n- Introdução a frameworks populares (Spring, Hibernate)\n- Desenvolvimento de aplicações web com Java EE");
        jScrollPane2.setViewportView(jTextPane1);

        jPanel1.add(jScrollPane2);
        jScrollPane2.setBounds(10, 260, 630, 340);
