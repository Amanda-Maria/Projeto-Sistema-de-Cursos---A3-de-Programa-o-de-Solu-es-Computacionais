...
public class TelaLogica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Lógica de Programação");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(17, 27, 280, 29);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogica().setVisible(true);
            }
        });
    }
